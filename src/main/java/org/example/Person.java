...
public record Person(int id, String firstName, String lastName, Date birthday, String gender, Address address,
    ...
    public String toString() {
        return String.format("| %-3d | %-10s | %-10s | %-10s | %-10s %s %-15s | %-20s %s %-20s |", id, firstName, lastName, new SimpleDateFormat("yyyy.MM.dd").format(birthday), gender, address.toString(), phonenumber, email, job, notes);
    }
}
